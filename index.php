...
// Settings is a modal now (opened from the avatar dropdown). ?page=settings still works:
// it shows the dashboard with the modal open (the Google Drive redirect relies on this).
$openSettings = false;
if ($page === 'settings') { $page = 'dashboard'; $openSettings = true; }
        ...
        <div class="top-actions">
            ...
            <div class="notification-menu" id="notificationMenu">
                ...
                <div class="notification-dropdown" id="notificationDropdown" hidden>
                    <div class="notification-dropdown-header"><b>Recent activity</b><a href="?page=settings#activity" class="text-link">View all</a></div>
            ...
            <div class="account-menu" id="accountMenu">
                ...
                <div class="account-dropdown" id="accountDropdown" hidden>
                    ...
                    <a href="?page=settings" class="ghost-btn account-edit-btn" id="settingsMenuLink"><i class="bx bx-cog"></i> <span data-i18n="nav.settings">Settings</span></a>
    ...
    <aside class="sidebar" id="sidebar" role="navigation" aria-label="Workspace navigation">
        ...
        <div class="side-section">
            ...
            <?php
                ...
                // Settings lives in the avatar dropdown (top-right), not the sidebar —
        ...
        <div class="sidebar-bottom"><div class="net-status" id="netStatus" role="status" aria-live="polite" title="Internet Connection"><div class="net-status-head"><span class="net-status-label" data-i18n="net.title">Internet Connection</span><i class="bx bx-wifi" id="netStatusIcon" aria-hidden="true"></i></div><div class="net-status-state"><span class="net-dot" aria-hidden="true"></span><span class="net-text-on" data-i18n="net.connected">Connected</span><span class="net-text-off" data-i18n="net.offline">Offline</span></div></div></div>
    </aside>
    ...
    <main class="main" id="mainContent" tabindex="-1">
        ...
        <div class="save-setup-banner" id="saveSetupBanner" hidden>
            ...
            <div class="save-setup-actions">
                ...
                <a class="small-btn ghost-btn" href="?page=settings#backup"><i class="bx bx-cog"></i> Choose a custom folder</a>
            </div>
        </div>
        ...
        <?php elseif ($page === 'dashboard' && $experienceLevel === 'intermediate'): ?>
            ...
            <section class="panel"><div class="panel-head"><h2>Need a refresher?</h2></div><p class="muted">Replay the guided tour or revisit the beginner steps anytime from <a class="text-link" href="?page=settings#guidance">Settings</a>.</p></section>
            <section class="panel dash-level-panel dash-level-compact">
                <div class="panel-head"><h2><i class="bx bx-trophy"></i> Your Rank</h2><span class="muted">Every action earns XP</span></div>
                <div class="dash-level-row">
                    <div class="dash-rank-icon-wrap"><i class="bx bx-code-alt" id="dashRankIcon"></i></div>
...
?>
<div class="modal-backdrop settings-modal" id="settingsModal" aria-hidden="true"><div class="settings-modal-box" role="dialog" aria-modal="true" aria-label="Settings" tabindex="-1">
<div class="settings-modal-head" aria-hidden="true"><span data-i18n="settings.title">Settings</span></div>
<button type="button" class="modal-close" id="settingsModalClose" aria-label="Close settings"><i class="bx bx-x"></i></button>
            <div class="settings-shell" id="settingsShell">
                <nav class="settings-nav" role="tablist" aria-orientation="vertical" aria-label="Settings sections"><button type="button" class="settings-tab active" role="tab" id="tab-account" data-tab="account" aria-selected="true" aria-controls="pane-account" tabindex="0"><i class="bx bx-user-circle"></i><span data-i18n="settings.tabAccount">Account</span></button><button type="button" class="settings-tab" role="tab" id="tab-appearance" data-tab="appearance" aria-selected="false" aria-controls="pane-appearance" tabindex="-1"><i class="bx bx-moon"></i><span data-i18n="settings.appearance">Appearance</span></button><button type="button" class="settings-tab" role="tab" id="tab-guidance" data-tab="guidance" aria-selected="false" aria-controls="pane-guidance" tabindex="-1"><i class="bx bx-compass"></i><span data-i18n="settings.tabGuidance">Guidance</span></button><button type="button" class="settings-tab" role="tab" id="tab-backup" data-tab="backup" aria-selected="false" aria-controls="pane-backup" tabindex="-1"><i class="bx bx-cloud-upload"></i><span data-i18n="settings.tabBackup">Backup</span></button><button type="button" class="settings-tab" role="tab" id="tab-about" data-tab="about" aria-selected="false" aria-controls="pane-about" tabindex="-1"><i class="bx bx-shield-alt-2"></i><span data-i18n="settings.aboutLegal">About &amp; Legal</span></button><button type="button" class="settings-tab" role="tab" id="tab-activity" data-tab="activity" aria-selected="false" aria-controls="pane-activity" tabindex="-1"><i class="bx bx-history"></i><span data-i18n="settings.tabActivity">Activity</span></button></nav>
                <div class="settings-content">
                    <section class="settings-pane" id="pane-account" data-pane="account" role="tabpanel" aria-labelledby="tab-account"><h2 class="settings-pane-title" data-i18n="settings.tabAccount">Account</h2><div class="settings-account" id="settingsAccountBody"><p class="muted">Loading profile…</p></div></section>
                    <section class="settings-pane" id="pane-appearance" data-pane="appearance" role="tabpanel" aria-labelledby="tab-appearance" hidden><h2 class="settings-pane-title" data-i18n="settings.appearance">Appearance</h2>            <section class="panel appearance-panel"><div class="appearance-group"><h3 class="appearance-label">Theme</h3><p class="muted appearance-hint" data-i18n="settings.themeNote">Theme is stored locally in your browser.</p><div class="theme-choices" role="radiogroup" aria-label="Theme"><button type="button" class="theme-choice" role="radio" aria-checked="false" data-theme-mode="light"><span class="theme-preview theme-preview-light" aria-hidden="true"></span><span class="theme-choice-name"><i class="bx bx-sun"></i> Light</span><span class="theme-choice-desc">Bright surfaces</span></button><button type="button" class="theme-choice" role="radio" aria-checked="false" data-theme-mode="dark"><span class="theme-preview theme-preview-dark" aria-hidden="true"></span><span class="theme-choice-name"><i class="bx bx-moon"></i> Dark</span><span class="theme-choice-desc">Easy on the eyes</span></button><button type="button" class="theme-choice" role="radio" aria-checked="false" data-theme-mode="system"><span class="theme-preview theme-preview-system" aria-hidden="true"></span><span class="theme-choice-name"><i class="bx bx-desktop"></i> System</span><span class="theme-choice-desc">Matches your device</span></button></div></div><div class="appearance-group"><h3 class="appearance-label">Code editor text size</h3><p class="muted appearance-hint">Applies to the Playgrounds, Notes and snippet editors.</p><div class="seg-group" role="radiogroup" aria-label="Code editor text size"><button type="button" class="seg-btn" role="radio" aria-checked="false" data-editor-size="11.5">Small</button><button type="button" class="seg-btn" role="radio" aria-checked="false" data-editor-size="12.5">Default</button><button type="button" class="seg-btn" role="radio" aria-checked="false" data-editor-size="14">Large</button><button type="button" class="seg-btn" role="radio" aria-checked="false" data-editor-size="16">Extra large</button></div><pre class="appearance-code-sample" aria-hidden="true"><code>function greet(name) {
  return "Hello, " + name + "!";
}</code></pre></div><div class="appearance-group"><label class="switch-row"><span>Reduce motion</span> <input type="checkbox" id="reduceMotionSetting"><span class="switch"></span></label><p class="muted appearance-hint">Turns off animations and transitions across the app. Off by default; if your device already asks for reduced motion, that is respected too.</p></div><div class="appearance-group appearance-actions"><button type="button" class="ghost-btn" id="resetAppearanceBtn"><i class="bx bx-reset"></i> Reset appearance</button></div></section></section>
                    <section class="settings-pane" id="pane-guidance" data-pane="guidance" role="tabpanel" aria-labelledby="tab-guidance" hidden><h2 class="settings-pane-title" data-i18n="settings.tabGuidance">Guidance</h2><section class="panel"><h2 data-i18n="settings.experienceLevel">Experience level</h2><p class="muted"><span data-i18n="settings.currentLevel">Current level:</span> <span class="experience-badge" id="experienceBadge"><?php echo e($experienceLabel); ?></span></p><div class="level-trail" id="levelTrail"><?php foreach ($levelOrder as $i => $lvl): ?><?php if ($i > 0): ?><div class="level-trail-line<?php echo $i - 1 < $curLevelIdx ? ' done' : ''; ?>"></div><?php endif; ?><button type="button" class="level-trail-step<?php echo $i <= $curLevelIdx ? ' done' : ''; ?><?php echo $i === $curLevelIdx ? ' current' : ''; ?>" title="<?php echo e(ucfirst($lvl)); ?>"><span class="trail-dot"><i class="bx <?php echo $levelIcons[$lvl]; ?>"></i></span><span class="trail-label"><?php echo e(ucfirst($lvl)); ?></span></button><?php endforeach; ?></div><p class="muted" data-i18n="settings.experienceNote">This decides how much guidance is shown across the workspace.</p><button class="ghost-btn" id="changeExperienceBtn"><i class="bx bx-user-check"></i> <span data-i18n="settings.changeExperience">Change experience level</span></button><button class="ghost-btn" id="replayTour"><i class="bx bx-play"></i> <span data-i18n="settings.replayTour">Replay guided tour</span></button></section></section>
                    <section class="settings-pane" id="pane-backup" data-pane="backup" role="tabpanel" aria-labelledby="tab-backup" hidden><h2 class="settings-pane-title" data-i18n="settings.tabBackup">Backup</h2><section class="panel" id="localDiskBackup"><h2 data-i18n="settings.localBackup">Local disk backup</h2><p class="muted">Every project, snippet and note is mirrored to a dedicated folder on this computer — <code>C:\A-CodePlayground\BackupFiles</code> by default — so your work lives on disk, not only inside the browser.</p><div class="disk-status" id="diskStatusBody"><p class="muted">Checking local save status…</p></div><div class="disk-actions"><button class="ghost-btn" id="saveBackupBtn"><i class="bx bx-save"></i> <span data-i18n="settings.saveBackupNow">Save backup to disk now</span></button><button class="ghost-btn" id="downloadBackupBtn"><i class="bx bx-download"></i> <span data-i18n="settings.downloadBackupFile">Download backup file</span></button><button class="ghost-btn" id="shareBackupBtn" hidden><i class="bx bx-share-alt"></i> <span>Share / save to phone</span></button></div><p class="muted backup-phone-tip"><i class="bx bx-mobile-alt"></i> <b>On a phone or tablet?</b> The folder above is on the computer running this app, not on your phone. Use <b>Download backup file</b> (it lands in your Downloads or the Files app) or <b>Share / save to phone</b> to keep a copy on the phone, or connect Google Drive below. <b>Import backup file</b> restores one from your phone.</p><div class="form-grid" style="margin-top:14px"><label class="full">Save location<input id="dataLocationInput" class="input" placeholder="Loading default location…" spellcheck="false" autocomplete="off" aria-describedby="dataLocationHint"></label><p class="field-hint is-error full" id="dataLocationHint" role="alert" hidden><i class="bx bx-x-circle"></i><span></span></p></div><p class="muted">Leave blank to use the automatic default (a dedicated <code>C:\A-CodePlayground\BackupFiles</code> folder, created for you the first time this runs — or the next available local drive if <code>C:</code> isn't usable), or enter a relative folder name (e.g. <code>my-backups</code>) or a full path (e.g. <code>D:\A-CodePlayground</code>) to save somewhere else instead. Pasting a path straight from Explorer’s “Copy as path” works too. Existing files are not moved automatically.</p><div class="disk-actions"><button class="ghost-btn" id="saveLocationBtn"><i class="bx bx-folder"></i> <span data-i18n="settings.saveLocation">Save location</span></button><button class="ghost-btn" id="resetLocationBtn"><i class="bx bx-reset"></i> <span data-i18n="settings.resetLocation">Reset to default</span></button></div><hr style="border:0;border-top:1px solid var(--border,#e5e7eb);margin:16px 0"><p class="muted"><b>Export / Import</b> — move your workspace to another computer, or restore an older copy.</p><div class="disk-actions"><button class="ghost-btn" id="importBackupBtn"><i class="bx bx-upload"></i> <span data-i18n="settings.importBackup">Import backup file</span></button><input type="file" id="importBackupInput" accept="application/json,.json" hidden></div></section><section class="panel" id="googleDriveBackup"><h2><i class="bx bxl-google"></i> Google Drive backup</h2><p class="muted">Sync a backup of your projects, snippets and notes to <b>your own</b> Google Drive. Each account connects its own Google account, and the app can only see the backup files it creates — never the rest of your Drive. XP and rank are not part of a backup.</p><div class="disk-status" id="gdriveBody"><p class="muted">Checking Google Drive…</p></div></section></section>
                    <section class="settings-pane" id="pane-about" data-pane="about" role="tabpanel" aria-labelledby="tab-about" hidden><h2 class="settings-pane-title" data-i18n="settings.aboutLegal">About &amp; Legal</h2><section class="panel legal-panel" id="aboutLegal"><h3 class="legal-panel-subtitle"><i class="bx bx-lock-alt"></i> <span data-i18n="settings.privacyDpa">Privacy Policy &mdash; Data Privacy Act of 2012</span></h3><div class="legal-page" id="legalPageBody"><?php render_privacy_policy_intro(); ?><?php render_privacy_policy_sections(); ?></div></section></section>
                    <section class="settings-pane" id="pane-activity" data-pane="activity" role="tabpanel" aria-labelledby="tab-activity" hidden><h2 class="settings-pane-title" data-i18n="settings.tabActivity">Activity</h2><section class="panel"><div id="activityList" class="activity-list"><div class="empty">No activity yet.</div></div></section></section>
                </div>
            </div>
</div></div>
...
window.OPEN_SETTINGS = <?php echo $openSettings ? 'true' : 'false'; ?>;
